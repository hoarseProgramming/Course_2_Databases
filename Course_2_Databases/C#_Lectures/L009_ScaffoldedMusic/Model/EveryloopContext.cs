...
public partial class EveryloopContext : DbContext
{
    ...
    public virtual DbSet<Exercise1> Exercise1s { get; set; }

    public virtual DbSet<Exercise2> Exercise2s { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Exercise1>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("Exercise1", "music");

            entity.Property(e => e.Name).HasMaxLength(120);
        });

        modelBuilder.Entity<Exercise2>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("Exercise2", "music");

            entity.Property(e => e.Name).HasMaxLength(120);
            entity.Property(e => e.NumberOfArtistsInPlaylist).HasColumnName("Number of artists in playlist");
        });
